        ...
        body: Container(
          child: Padding(
            ...
            child: Column(
               children: <Widget>[
                 Text(
                   'To turn on Subtitles ("CC") during video playback to display the audio for movies and TV shows as top right allowing you to choose avaliable languages for subtitles and audio.',
                   style: TextStyle(
                     fontSize: 16,
                      fontFamily: 'Roboto6',
                   ),
